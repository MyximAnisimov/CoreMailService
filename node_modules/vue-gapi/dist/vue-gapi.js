...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.VueGapi = {}, global.Vue));
})(this, (function (exports, vue) { 'use strict';

  var injectKey = Symbol('gapi');
  ...
  var index = {
     ...
     */
    install: function install(app, clientConfig) {
      var clientProvider = new GapiClientProvider(clientConfig);
      var sessionStorage = new SessionStorage();
      var gapi = new GoogleAuthService(clientProvider, sessionStorage);
